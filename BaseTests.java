...
//	public static driver = new AndroidDriver(url, options);
//	public static driver = new AndroidDriver(new URL("http://localhost:4723/wd/hub"),options);
...
//				url = new URL("http://0.0.0.0:4723/wd/hub");
		 ...
		 * WebDriverManager.edgedriver().setup(); driver.set(new EdgeDriver()); } else
		 * if(browserName.equalsIgnoreCase("IE")) { WebDriverManager.iedriver().setup();
		 * driver.set(new InternetExplorerDriver()); } else
		 * if(browserName.equalsIgnoreCase("firefox")) {
		 * WebDriverManager.firefoxdriver().setup(); driver.set(new FirefoxDriver()); }
		 * else if(browserName.equalsIgnoreCase("safari")) {
		 * WebDriverManager.safaridriver().setup(); driver.set(new SafariDriver()); }
		 */
