...
public class BaseTests {
	...
	public static ByAndroidUIAutomator ant;
			...
			//	options.setApp(System.getProperty("user.dir") + "/VodQA.apk");
				...
				AppiumDriverLocalService service = AppiumDriverLocalService.buildService(
						new AppiumServiceBuilder().withIPAddress("127.0.0.1")
						  .withArgument(GeneralServerFlag.BASEPATH, "/wd/hub").usingPort(4726).withArgument(() -> "--allow-insecure", "chromedriver_autodownload"));
				service.start();
				/*
				 * // service = 
				 * new AppiumServiceBuilder() // .withIPAddress("127.0.0.1")
				 * .withArgument(GeneralServerFlag.BASEPATH, "/wd/hub") .withArgument(null,
				 * appium --allow-insecure chromedriver_autodownload) .usingPort(4723) .build();
				 * service.start();
				 */
